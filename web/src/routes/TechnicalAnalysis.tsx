...
import { EquityBriefPanel } from "../components/EquityBriefPanel";
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-[1800px] mx-auto px-3 py-3 flex flex-col gap-3">
        ...
        {/* Closed until asked for: the AI half costs a DeepSeek call per
            section, so nothing is generated by loading the page. */}
        {analysis.data && (
          <EquityBriefPanel ticker={analysis.data.ticker} market={analysis.data.market} />
        )}
